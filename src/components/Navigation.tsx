      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <button className="ml-4 px-6 py-2.5 text-sm font-semibold text-slate-900 bg-white hover:bg-slate-100 transition-colors duration-200 rounded-lg shadow-sm">
              Get Started
            </button>
          </div>
          ...
          <div className="px-6 py-4 space-y-1">
            {navLinks.map((link) => (
              <button
                key={link}
                onClick={() => scrollToSection(link)}
                className="block w-full text-left py-3 px-4 text-slate-300 hover:text-white hover:bg-slate-800 transition-colors duration-200 text-sm font-medium rounded-xl"
              >
                {link}
              </button>
            ))}
            <button className="block w-full mt-2 py-3 px-4 text-slate-900 bg-white hover:bg-slate-100 transition-colors duration-200 text-sm font-semibold rounded-xl text-center shadow-sm">
              Get Started
            </button>
          </div>
        </div>
